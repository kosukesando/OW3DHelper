...
function export_nc_kinematics(s::PostProcessSetting; basedir=".")
    ...
    mktemp() do path, io
        ...
        for i in 1:4
            ...
            defVar(ds, "phi$phase_str", kf.phi[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m²/s"))
            defVar(ds, "u$phase_str", kf.u[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
            defVar(ds, "v$phase_str", kf.v[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
            defVar(ds, "w$phase_str", kf.w[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
            defVar(ds, "uz$phase_str", kf.uz[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
            defVar(ds, "vz$phase_str", kf.vz[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
            defVar(ds, "wz$phase_str", kf.wz[:, :, :, :], ("t", "z", "x", "y"), attrib=OrderedDict("units" => "m/s"))
        end
